...
startup
{
	...
	settings.Add("dungeons", true, "Pendants/Crystals (sword up)");
...
split
{
	...
	var dungeons = settings["dungeons"] && swordUp && current.mapTile != 0x60 && current.mapTile != 0; //this excludes Aga1 and Ganon
	...
	return escape || dungeons || masterSword || agahnim1 || agahnim2 || end;
}
